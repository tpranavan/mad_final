...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_1 = "car_type";
    ...
    public static final String COL_7 = "No_of_cars";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("CREATE TABLE " + TABLE_NAME + "(car_type text,Name text, Phone_no text primary key, Email text,Check_in text, Check_out text, No_of_cars integer, Total_cost integer)");
    ...
    public  boolean updateDetail(String car_type, String Name, String Phone_no, String Email, String Check_in, String Check_out, String No_of_cars, String Total_cost){
        SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
        ContentValues contentValues= new ContentValues();
        contentValues.put(COL_1, car_type);
        contentValues.put(COL_2, Name);
